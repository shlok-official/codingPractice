...
屈远亮 uploaded an item
7:12 PM
Text
Jack.txt
No recorded activity before September 19, 2016
...
public class mypart {
    ...
    public static int[] getLocation(int player){//local the chesspiece
        int[] tmp = new int[2];
